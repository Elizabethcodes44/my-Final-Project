...
function Health() {
  ...
  return (
    <div className="healthContainer" id="health">
      ...
      <h4>Congratulations on the anticipation of your little one! Discover your expected due date effortlessly by completing the form below. Please keep in mind that babies can arrive up to two weeks before or after the calculated due date. </h4>
      <div className="form-container">
        <label htmlFor="lastPeriod">Enter the date of your last period:</label>
        <br />
        <input
          type="date"
          id="lastPeriod"
